...
public class HomeScreenConfigBody implements Serializable
{

    @SerializedName("dataJSON")
    @Expose
    private HomeScreenConfigDataJSON dataJSON;
    ...
    private final static long serialVersionUID = 96974345995875798L;

    public HomeScreenConfigDataJSON getDataJSON() {
        return dataJSON;
    }

    public void setDataJSON(HomeScreenConfigDataJSON dataJSON) {
